...
const cases = [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1537151608804-ea6d11548232?q=80&w=1000&auto=format&fit=crop"
  },
  {
    title: "Mia",
...
export default function Gallery() {
  ...
  return (
    <section ref={targetRef} className="h-[250vh] relative bg-primary">
      <div className="sticky top-0 h-screen flex items-center overflow-hidden">
        ...
        <div className="container mx-auto px-6 lg:px-24 absolute top-20 md:top-32 left-0 right-0 z-10 w-full pointer-events-none">
        ...
        <motion.div style={{ x }} className="flex gap-8 md:gap-16 px-6 lg:px-24 pt-32 gallery-track w-max">
          {cases.map((c, i) => (
            <div 
              key={i} 
